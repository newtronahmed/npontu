...
<head>
    ...
    {{-- <link rel="stylesheet" href="/plugins/bootstrap-date-picker/css/bootstrap-datepicker.css"> --}}
{{-- <script src="/plugins/bootstrap-date-picker/js/bootstrap-datepicker.min.js"></script>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item " >
                            {{-- <a href="{{route('updates')}}">updates</a> --}}
                            <a href="{{route('activity.showUpdates')}}" class="nav-link text-color" >Updates</a>
                        </li>
